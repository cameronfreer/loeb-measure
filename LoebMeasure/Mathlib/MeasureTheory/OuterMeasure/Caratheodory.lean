...
Promoted here because the Loeb measure's completeness instance must **wrap** this
theorem rather than reprove it (ADR-0003). Upstream acceptance is nonblocking; local
availability is not.
